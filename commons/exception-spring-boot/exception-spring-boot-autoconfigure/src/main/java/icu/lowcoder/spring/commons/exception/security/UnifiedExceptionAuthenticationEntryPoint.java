...
public final class UnifiedExceptionAuthenticationEntryPoint implements AuthenticationEntryPoint {
	...
	public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException) throws IOException, ServletException {
		...
		if (exceptionResponseBuilder != null) {
			UnifiedExceptionResponse unifiedExceptionResponse = exceptionResponseBuilder.build(authException, request.getRequestURI());
